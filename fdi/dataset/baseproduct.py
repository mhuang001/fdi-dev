...
class BaseProduct( AbstractComposite, Copyable, Serializable,  EventSender):
    ...
    BaseProduct class (level ALL) schema 1.1 inheriting [None]. Automatically generated from fdi/dataset/resources/BaseProduct.yml on 2020-11-06 19:58:50.505740.
