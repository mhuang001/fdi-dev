...
This package implement a data product structure modeled after Herschel Common Software System (v15)  products, taking other  requirements of specific missions into account.
...
This package provides the following parameter types: 
   * Parameter: Contains an arbitrary value and no unit
   * NumericParameter: Contains a number with possibly a unit
